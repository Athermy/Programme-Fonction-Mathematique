...
public class Main {
    ...
    public void init() {
        ...
        /*
        JComboBox proposant à l'utilisateur de choisir une des fonctions en dur
        A SUPPRIMER DANS VOTRE PROJET et à remplacer par un JTextField
        */
        JComboBox<String> dropdownMenu = new JComboBox<>(Plot.FUNCTION_DESCRIPTIONS);
        ...
        dropdownMenu.addActionListener(event -> {
            plot.setFunction(dropdownMenu.getSelectedIndex());
            widgetTrace.repaint();
        });
